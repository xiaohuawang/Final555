            ...
            <div class="col-md-8">
               <div class="panel panel-default">
                  <div class="panel-heading clearfix">
                     ...
                     <h3 class="panel-title">STB types</h3>
                  </div>
                  <br>
                  <div class="col-xs-6">
         ...
         <div class="row">
            <div class="col-md-8">
               <div class="panel panel-default">
                  <div class="panel-heading clearfix">
                     <i class="icon-calendar"></i>
                     <h3 class="panel-title">STB Dimensions</h3>
                  </div>
                  <br>
                  <div class="col-xs-6">
         ...
         <div class="row">
            <div class="col-md-8">
               <div class="panel panel-default">
                  <div class="panel-heading clearfix">
                     <i class="icon-calendar"></i>
                     <h3 class="panel-title">Cost and Other Charges</h3>
                  </div>
                  <br>
                  <div class="col-xs-6">
                     <div class="input-group">
         ...
         <div class="row">
            <div class="col-md-8">
               <div class="panel panel-default">
                  <div class="panel-heading clearfix">
                     <i class="icon-calendar"></i>
                     <h3 class="panel-title">Billing Type</h3>
                  </div>
                  <br>
                  <div>
                     <div class="col-xs-6">
            ...
            <div class="row">
               <div class="col-md-8">
                  <div class="panel panel-default">
                     <div class="panel-heading clearfix">
                        <i class="icon-calendar"></i>
                        <h3 class="panel-title">Set Top Box Details: </h3>
                     </div>
                     <br>
                     <div class="col-xs-6">
                        <div class="input-group">
            ...
            <div class="row">
               <div class="col-md-8">
                  <div class="panel panel-default">
                     <div class="panel-heading clearfix">
                        <i class="icon-calendar"></i>
                        <h3 class="panel-title">Set Top Box Status: </h3>
                     </div>
                     <br>
                     <div class="col-xs-6">
