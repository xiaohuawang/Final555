               ...
               <div class="controls">
                  <form method="post" action="channel-package">
                     ...
                     <div class="form-group">
                        ...
                        <div class="checkbox">
                           <label><input name="standard" type="checkbox" value="">Standard</label>
                        </div>
                        <div class="checkbox">
                           <label><input name="hd" type="checkbox" value="">High Definition</label>
                        </div>
                        <div class="checkbox">
                           <label><input name="hdRecorder"type="checkbox" value="">HD Recorder</label>
                        </div>
                        <div class="checkbox">
                           <label><input name="iptv" type="checkbox" value="">IPTV</label>
                        </div>
                     </div>
                     ...
                     <input id= "Yes" type="radio" name="addByDefault" value="Yes" name="yes"> <span>Yes</span>
                     <input id= "No" type="radio" name="addByDefault" value="No" name="no"> <span>No</span><br>
                     <br>
